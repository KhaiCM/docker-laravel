...
<head>
        <meta charset="utf-8">
        <title>Pivot | Blog</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <link href="{{ asset('frontend/css/flexslider.min.css" rel="stylesheet" type="text/css" media="all"/>
        <link href="{{ asset('frontend/css/line-icons.min.css" rel="stylesheet" type="text/css" media="all"/>
        <link href="{{ asset('frontend/css/elegant-icons.min.css" rel="stylesheet" type="text/css" media="all"/>
        ...
        <script src="{{ asset('frontend/js/modernizr-2.6.2-respond-1.1.0.min.js"></script>
    </head>
    <body>
    	<div class="loader">
    		<div class="spinner">
        ...
        <script src="{{ asset('frontend/js/twitterFetcher_v10_min.js"></script>
